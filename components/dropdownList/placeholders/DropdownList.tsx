export default function DropdownListPlaceholder() {
	return <div className="rw-widget-input rw-widget-picker rw-widget-container">
...
{/*			<div className="flex items-center space-x-2 w-full">
			...
			<div className="flex items-center w-full space-x-2 max-w-[480px] mt-3">
				...
				<div className="h-3.5 bg-gray-300 rounded-full dark:bg-gray-600 w-24"></div>
			</div>
