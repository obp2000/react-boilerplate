...
// const modOrderItems = (orderItems: OrderItemSelect[]) => orderItems.map(modOrderItem)
...
//   total_weight,
//   ...values
// }: OrderFormValues): Partial<OrderFormValues> => {
//   // if (customer) {
//   //   values.customer_id = customer.id
//   // }
//   if (values.orderItems) {
//     values.orderItems = modOrderItems(values.orderItems)
//   }
//   return values
// }
