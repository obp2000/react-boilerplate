...
// const getObject = {
// 	customers: () => import('@/app/customers/db').then(({ getObject }) => getObject),
// 	products: () => import('@/app/products/db').then(({ getObject }) => getObject),
// 	orders: () => import('@/app/orders/db').then(({ getObject }) => getObject),
// }
...
// const initObject = {
// 	customers: () => import('@/app/customers/customer.json').then((module) => module.default),
// 	products: () => import('@/app/products/product.json').then((module) => module.default),
// 	orders: () => import('@/app/orders/order.json').then((module) => module.default),
// }

// export async function getInitObject(table: string) {
// 	return initObject[table as keyof typeof initObject]()
// }
