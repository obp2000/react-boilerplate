...
const getObjects = (base_url) =>
    (page, term, accessToken) => axios.get(`${base_url}/`, {
        params: {
            page,
...
const getObject = (base_url) =>
    (id, accessToken) => axios.get(`${base_url}/${id}`,
        tokenHeaders(accessToken)
    )
    .catch(error_handler)
    .then(extract_data)
...
export const createOrUpdateObject = (base_url, to_form_data = false) =>
    (data, accessToken) => axios({
...
export const deleteObject = (base_url) => (id, accessToken) =>
    axios.delete(`${base_url}/${id}`, tokenHeaders(accessToken))
    .catch(error_handler)
...
export const searchObjects = (base_url) => (term, accessToken) =>
    axios.get(`${base_url}/`, {
        params: {
            term: decodeURIComponent(term),
            page_size: 1000000
...
export const buildReducer = (initialState) =>
    createReducer(reducer_actions, initialState)
